...
function SuperAdminPanel() {
  ...
  const Chevron = ({ open }) => (
    <svg className={`chevron ${open ? 'chevron-rotate' : ''}`} width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true">
  ...
  return (
    <div className="super-admin-panel">
      ...
      <section className="existing-container">
        ...
        <div className="table-container">
          <table className="company-table">
            <thead>
              <tr>
                <th>ID</th><th>Name</th><th>Slug</th><th>Logo URL</th><th>Tagline</th>
              </tr>
            </thead>
            <tbody>
          ...
          <div className="pagination">
            <button onClick={() => setCurrentCompanyPage((p) => p - 1)} disabled={currentCompanyPage === 1}>Previous</button>
            <button onClick={() => setCurrentCompanyPage((p) => p + 1)} disabled={currentCompanyPage >= Math.ceil(companies.length / companiesPerPage)}>Next</button>
          </div>
        </div>
      </section>
      ...
      <section className={`create-collapsible ${isCreateCompanyOpen ? 'is-open' : ''}`}>
        <button type="button" className="collapsible-trigger" onClick={() => setIsCreateCompanyOpen((v) => !v)} aria-expanded={isCreateCompanyOpen}>
            ...
            <form onSubmit={handleCreateCompany}>
              <div className="grid-layout">
                <div>
                  ...
                  <input className="input-field" value={companyName} onChange={(e) => setCompanyName(e.target.value)} placeholder="Company Name" required />
                </div>
              </div>
              <div className="grid-layout">
                <div>
                ...
                <div>
                  ...
                  <input className="input-field" value={tagline} onChange={(e) => setTagline(e.target.value)} placeholder="Company Tagline" />
                </div>
              </div>
      ...
      <section className="existing-container">
        ...
        <div className="table-container">
          <table className="admin-table">
            <thead>
              <tr>
                <th>Name</th><th>Email</th><th>Company</th><th>Slug</th>
              </tr>
            </thead>
            <tbody>
          ...
          <div className="pagination">
            <button onClick={() => setCurrentAdminPage((p) => p - 1)} disabled={currentAdminPage === 1}>Previous</button>
            <button onClick={() => setCurrentAdminPage((p) => p + 1)} disabled={currentAdminPage >= Math.ceil(admins.length / adminsPerPage)}>Next</button>
          </div>
        </div>
      </section>
      ...
      <section className={`create-collapsible ${isCreateAdminOpen ? 'is-open' : ''}`}>
        <button type="button" className="collapsible-trigger" onClick={() => setIsCreateAdminOpen((v) => !v)} aria-expanded={isCreateAdminOpen}>
          ...
          <div className="create-container">
            <form onSubmit={handleCreateAdmin}>
              <div className="grid-layout">
                <div>
                  <label className="label">Name *</label>
                  <input className="input-field" value={adminName} onChange={(e) => setAdminName(e.target.value)} required placeholder="Admin Name" />
                </div>
                <div>
                  <label className="label">Email *</label>
                  <input className="input-field" type="email" value={adminEmail} onChange={(e) => setAdminEmail(e.target.value)} required placeholder="admin@company.com" />
                </div>
              </div>
              <div className="grid-layout">
                <div>
                  <label className="label">Password *</label>
                  <input className="input-field" type="password" value={adminPassword} onChange={(e) => setAdminPassword(e.target.value)} required placeholder="Temporary Password" />
                </div>
                <div>
                  <label className="label">Company *</label>
                  <select className="input-field" value={adminCompanyId} onChange={(e) => setAdminCompanyId(e.target.value)} required>
